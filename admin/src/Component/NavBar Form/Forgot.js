...
import { CreateForgot, UpdateForgot } from '../../actions/Forgot.action'
...
const mapStateToProps = (store) => {
    return {
        createForgot: store.createForgot
    }
}
const mapDispatchToProps = (dispatch) => {
    return {
        forgotPass: (data) => dispatch(CreateForgot(data)),
        editpass: (data) => dispatch(UpdateForgot(data))
    }
}
